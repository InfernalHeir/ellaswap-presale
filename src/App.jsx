...
const App = () => {
  const time = new Date();
  const now = Math.floor(time.getTime() / 1000);
  const left = 1611133200;
  const diff = Math.floor(left - now);
  time.setSeconds(time.getSeconds() + 86400); // After 20th jan it will go negative
                ...
                <div className="vc_column-inner ">
                  <div className="wpb_wrapper">
                      ...
                      <div className="wpb_wrapper">
                        <h2 className="future">
                          <div className="typewriter_wrap">
                            <span
                              href=""
                              class="typewrite text-ella typewriter"
                              data-period="2000"
                              data-type='[ "Trade", "Issue" ]'
                            ></span>
                          </div>
                          your crypto assets with the most powerful Automated
                          Liquidity platform for crypto assets
                        </h2>
                        <p className="lead color-secondary">
                          <span data-slate-fragment="">
                            ...
                            decentralized price oracle to provide pure on-chain
                            liquidity for everyone at zero slippage.
                          </span>
                        </p>
                        <ul className="btns">
                          <li>
                            <a className="btn">&nbsp;Join Presale</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <ul className="social ">
                      ...
                      <li>
                        <a href="https://t.me/ellaswap" target="_blank">
                          <em className="fas fa-paper-plane"></em>
                        </a>
                      </li>
                      <li>
                        <a href="http://t.me/ellaswapann" target="_blank">
                          <em className="fas fa-paper-plane"></em>
                        </a>
                      </li>
                    </ul>
                ...
                <div className="vc_column-inner ">
                  <div className="wpb_wrapper">
                    <div className="countdown-box text-center  countdown-header">
                      ...
                      >
                        <li className="col">
                          <span className="countdown-time days">0</span>
                          <span className="countdown-text days_text">Days</span>
                        </li>
                        <li className="col">
                          <span className="countdown-time hours">0</span>
                          <span className="countdown-text hours_text">
                            Hours
                          </span>
                        </li>
                        <li className="col">
                          <span className="countdown-time minutes">0</span>
                      ...
                      <a className="btn btn-alt btn-sm" target="_self">
                        Join &amp; BUY TOKEN NOW
                      </a>
                    ...
                    <div className="wpb_wrapper">
                      ...
                      >
                        <span className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1">
                          ELLA is a next-generation on-chain liquidity provider,
                          which leverages on chain link decentralized price
                          oracle to provide pure on-chain liquidity for everyone
                          at zero slippage.
                        </span>
                      </p>
                    ...
                    <div className="wpb_wrapper">
                      ...
                      <div className="blockHeadingContent-756c9114">
                        <span className="text-4505230f--HeadingH400-686c0942--textContentFamily-49a318e1">
                          <span
                            data-key="24da41d6a5ea48c496e7a7ca5df4a863"
                            ...
                            >
                              <span className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1">
                                <span data-key="65ab252a6fc34585bc792319169a9389">
                                  ...
                                  quantity on crypto-assets at market price with
                                  zero spillage unlike most dex
                                </span>
                              </span>
                            </p>
                          </div>
                            ...
                            >
                              <span className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1">
                                <span data-key="e0864b9606c640dc84ddbcf3943d2013">
                                  There are no minimum deposit requirements and
                            ...
                            >
                              <span className="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1">
                                <span data-key="fe02a1f0475948d29e9ac26ef57c18fa">
                                  LPs can create trading pairs with their tokens
                                </span>
                              </span>
                            </p>
                          </div>
                          ...
                          <div className="wpb_text_column wpb_content_element  vc_custom_1607233127862 text-center">
                            <div className="wpb_wrapper">
                              <p>
                                ...
                                Price Oracle. Chain link Price Oracles retrieve
                                the accurate Market price of the Network through
                                the Network of the Node. Ella Aims to provide an
                                accurate market price for every Crypto Assets so
                                traders will buy/sell without any impact on the
                                price of Crypto- assets. The result is that
                                traders can sell/buy all market price with Zero
                                slippage.
                              </p>
                            </div>
                          </div>
                            ...
                            <div className="wpb_wrapper">
                              ...
                              <ul className="whyella_ul">
                                ...
                                <li>
                                  ...
                                  <p>
                                    As seen in the above graphs, ChainLink, like
                                    AMMs, provides liquidity in the price range
                                    of zero to positive infinity, but the LINK
                                    price curve is stable at the market price.
                                    That is, most of the funds are gathered at
                                    the market price, which allows for frequent
                                    trading of the fund at zero slippage
                                    utilization.
                                  </p>
                                </li>
                                <li>
                                  ...
                                  <p>
                                    In the price curves above, each price curve
                                    consists of two parts: the bidding side to
                                    the left and the asking side to the right.
                                    These two parts may have a different depth,
                                    or liquidity, resulting in what is known as
                                    the bid-ask spread.
                                  </p>
                                </li>
                                {/* <li>
                        ...
                        <div className="wpb_wrapper">
                          ...
                          <div className="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_bounceInDown bounceInDown vc_custom_1607234202002 text-center wpb_start_animation animated">
                            <div className="wpb_wrapper">
                              <h4
                                data-v-074c60b6=""
                                className="sub-heading justify-content-center"
                              >
                                Tokenization
                              </h4>
                              <p data-v-074c60b6="">
                            ...
                            <div className="col-lg ">
                              <div className="single-roadmap roadmap-sm roadmap-done">
                                ...
                                <p>
                                  ...
                                  <br />
                                  Building smart contract for ELLA ERC-20 token
                                </p>
                              </div>
                            </div>
                        ...
                        <div className="wpb_wrapper">
                          <div className="section-head text-center">
                            <h2
                              ...
                              data-delay=".1"
                            >
                              <strong>Powered by a Team</strong>
                              <span>TEAM</span>
                            </h2>
                          </div>
                          <div className="wpb_text_column wpb_content_element  vc_custom_1520850810932 text-center">
                            <div className="wpb_wrapper">
                              <p>
                                The Team combines a passion for esports,
                                industry experise &amp; proven record in
                                finance, development, marketing &amp; licensing.
                              </p>
                            </div>
                          </div>
                        </div>
                            ...
                            <div className="team-info">
                              ...
                              <ul className="team-social">
                                <li>
                                  <a
                                    target="_blank"
                                    href="https://twitter.com/SaiMayreddy"
                                  >
                                    <em className="fab fa-twitter"></em>
                                  </a>
                                </li>
                      ...
                      <div className="vc_column-inner ">
                        <div className="wpb_wrapper">
                          <div className="team-member">
                            ...
                            <div className="team-info">
                              <h5 className="team-name">Izunna Isdore Ozuo</h5>
                              <span className="team-title">Legal Counsel</span>
                              <ul className="team-social">
                                <li>
                                  <a
                                    target="_blank"
                            ...
                            <div className="team-info">
                              ...
                              <ul className="team-social">
                                <li>
                                  <a
                                    target="_blank"
                                    href="https://m.facebook.com/shiznatkun?ref=bookmarks"
                                  >
                                    <em className="fab fa-facebook-f"></em>
                                  </a>
                                </li>
                ...
                <div className="wpb_wrapper">
                  <div className="section-head text-center">
                    <h2
                      ...
                      data-delay=".1"
                    >
                      <strong>More About Ella Swap</strong>{" "}
                      <span>Ella swap</span>
                    </h2>
                  </div>
                      ...
                      <div className="col-lg-4 offset-lg-0 col-sm-8 offset-sm-2">
                        <div className="blog-item">
                          ...
                          <div className="blog-texts">
                            ...
                            <p>
                              The swapBase function sends an application request
                      ...
                      <div className="vc_tta-tabs-container">
                        <ul className="vc_tta-tabs-list">
                          <li className="vc_tta-tab vc_active" data-vc-tab="">
                            ...
                            >
                              <span className="vc_tta-title-text">General</span>
                            </a>
                          </li>
                          ...
                          <li className="vc_tta-tab" data-vc-tab="">
                            <a
                              ...
                              data-vc-container=".vc_tta"
                            >
                              <span className="vc_tta-title-text">Tokens</span>
                            </a>
                          </li>
                          <li className="vc_tta-tab" data-vc-tab="">
                            <a
                              ...
                              data-vc-container=".vc_tta"
                            >
                              <span className="vc_tta-title-text">Client</span>
                            </a>
                          </li>
                          <li className="vc_tta-tab" data-vc-tab="">
                            <a
                              ...
                              <div className="accordion" id="accordion-13">
                                  ...
                                  >
                                    <div className="card-body">
                                      <p>
                                        ...
                                        chain link decentralized price oracle to
                                        provide pure on-chain liquidity for
                                  ...
                                  >
                                    <div className="card-body">
                                      <p>
                                        ...
                                        liquidity. In order to minimize counter
                                        party risks for Liquidity providers,
                                        ELLA dynamically adjusts market prices
                                        to encourage arbitrageurs to step in and
                                        stabilize Liquidity Provider"s
                                        portfolios.
                                      </p>
                                    </div>
                                  </div>
                                ...
                                <div className="card">
                                  ...
                                  >
                                    <div className="card-body">
                                      <p>
                                        As a trader Each and every trader enjoys
                                        sufficient liquidity similar to that of
                                        centralized exchangesArbitrageurs can
                                        profit from selling large quantity on
                                        crypto-assets at market price with zero
                                        spillage unlike most dexSmart contracts
                                        can natively use ELLA liquidity to
                                        complete on-chain transactions.As a
                                        Liquidity ProviderThere are no minimal
                                        deposit requirements and restrictions on
                                        asset typesELLA charges a fee for each
                                        transaction and eventually distributes
                                        it to LPs as rewardsLPs can create
                                        trading pairs with their own tokensLPs
                                        can obtain liquidity by depositing their
                                        tokens they already own, without taking
                                        on price risk​​Next - The Protocol ELLA
                                        AdvantageLast updated 2 weeks ago WAS
                                        THIS PAGE HELPFUL?
                                      </p>
                                    </div>
                                  </div>
                              ...
                              <div className="accordion" id="accordion-958">
                                <div className="card">
                                  ...
                                  >
                                    <div className="card-body">
                                      <p>
                                        Chainlink is a tokenized oracle network
                                        that provides price and events data
                                        collected from on-chain and real-world
                                        sources.
                                      </p>
                                    </div>
                                  </div>
                                  ...
                                  >
                                    <div className="card-body">
                                      <p>
                                        ...
                                        opportunities to arbitrageurs to reward
                                        their role in helping to stabilize
                                        liquidity providers' portfolios.
                                      </p>
                                    </div>
                                  </div>
                                </div>
                                <div className="card">
                                  ...
                                  >
                                    <div className="card-body">
                                      <p>
                                        No. EllaSwap allows liquidity providers
                                        to deposit any amount of base or quote
                                        tokens. You deposit what you have,
                                        nothing more.
                                      </p>
                                    </div>
                                  </div>
                        ...
                        <div className="wpb_wrapper">
                          <div className="section-head text-center">
                            <h2
                              ...
                              data-delay=".1"
                            >
                              <strong>Contact Ella Finance</strong>{" "}
                              <span>CONTACT</span>
                            </h2>
                          </div>
                        </div>
                              ...
                              <ul className="contact-info c">
                                ...
                                <li>
                                  <a href="https://t.me/ellaswap">
                                    <em className="fa fa-paper-plane">tele</em>
                                    Join&nbsp;
                                  </a>
                                  us on Telegram
                                </li>
          ...
          <div className="row text-center">
            <div className="col-md-12">
              <ul className="social">
                ...
                <li>
                  <a target="_blank" href="https://t.me/ellaswap">
                    <em className="fa fa-telegram"></em>
                  </a>
                </li>
                <li>
                  <a target="_blank" href="https://t.me/ellaswapann">
                    <em className="fa fa-telegram"></em>
                  </a>
                </li>
              </ul>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <p>
                ...
                Republic of Macedonia, Serbia, Somalia, South Sudan, Sri Lanka,
                Sudan, Syria, Thailand, Trinidad & Tobago, Tunisia, Uganda,
                Ukraine, United State of America (USA), United States minor
                outlying Islands, Vanuatu, Venezuela, Yemen and Zimbabwe.
              </p>
